...
if __name__ == "__main__":
    ...
    """ Load dataset """
    # path = "E:/lijiawei/ConVUnext/data/ISIC"   # 数据集路径 #
    # path = "E:/lijiawei/ConVUnext/data/2017"
    # path = "E:/lijiawei/ConVUnext/data/PH2"
    # path = "E:/lijiawei/ConVUnext/data/BUSI"
    path = "E:/lijiawei/ConVUnext/data/ErYuan"
    (train_x, train_y), (test_x, test_y) = load_data(path)

    """ Hyperparameters """
    size = (256, 256)
    num_iter = 1
    # checkpoint_path = "E:/lijiawei/ETUnet-main/data/PH2-checkpoint1.pth"    # 权重路径 #
    # checkpoint_path = "E:/lijiawei/ETUnet-main/data/Isic2017-checkpoint.pth"
    # checkpoint_path = "E:/lijiawei/ETUnet-main/data/ETUnet-checkpoint.pth"
    # checkpoint_path = "E:/lijiawei/ETUnet-main/data/busi-checkpoint1.pth"
    checkpoint_path = "E:/lijiawei/ETUnet-main/data/ErYuan1-checkpoint.pth"

    """ Directories """
    create_dir("E:/lijiawei/ETUnet-main/ErYuan1-results")    # 测试可视化结果保存路径 #
    # create_dir("E:/lijiawei/ETUnet-main/one-results")
    # create_dir("E:/lijiawei/ETUnet-main/isic2017-results")
    # create_dir("E:/lijiawei/ETUnet-main/busi-results1")
    # create_dir("E:/lijiawei/ETUnet-main/ph2-results1")
    ...
    save_data = []
    # file = open("E:/lijiawei/ETUnet-main/data/one-test_results.csv", "w")    # 测试量化结果保存路径 #
    # file = open("E:/lijiawei/ETUnet-main/data/isic2017-results.csv", "w")
    # file = open("E:/lijiawei/ETUnet-main/data/PH2-results1.csv", "w")
    # file = open("E:/lijiawei/ETUnet-main/data/busi-results1.csv", "w")
    file = open("E:/lijiawei/ETUnet-main/data/ErYuan1_results.csv", "w")
    ...
    for i, (x, y) in tqdm(enumerate(zip(test_x, test_y)), total=len(test_x)):
        ...
        cv2.imwrite(f"E:/lijiawei/ETUnet-main/ErYuan1-results/{name}.png", cat_images)    # 测试可视化结果保存路径 #
        # cv2.imwrite(f"E:/lijiawei/ETUnet-main/one-results/{name}.png", cat_images)
        # cv2.imwrite(f"E:/lijiawei/ETUnet-main/isic2017-results/{name}.png", cat_images)
        # cv2.imwrite(f"E:/lijiawei/ETUnet-main/ph2-results1/{name}.png", cat_images)
        # cv2.imwrite(f"E:/lijiawei/ETUnet-main/busi-results1/{name}.png", cat_images)
